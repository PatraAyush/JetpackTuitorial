...
import com.example.ayush.ui.theme.AyushTheme
    ...
    Column {
        ...
        Card(
            ...
            Column(
                ...
                Text(text = "Jetpack Compose" ,color = colorResource(id = R.color.personal),style = MaterialTheme.typography.headlineSmall)
                ...
                Text(
                    text = "Login",
                    color = colorResource(id = R.color.LoginGreen),
                    fontSize = 35.sp,
                    modifier = Modifier
